...
const ProfileCard = () => {
    ...
    return(
            <div className="w-7/12 h-max mx-40 my-8 rounded-xl flex flex-col shadow-lg relative">
                ...
                <div className="w-full h-auto bg-white flex justify-between pb-8 rounded-b-xl">
                    <div className="w-2/4 h-max mt-16 mx-4">
                ...
                <div className="w-[17%] h-[30%] rounded-[50%] bg-white absolute top-28 left-10 flex items-center justify-center">
